...
function touchMove(e) {
    mouseX = e.touches[0].clientX - pixelDisplayer.margin - paddingLeft;
    mouseY = e.touches[0].clientY - pixelDisplayer.margin - paddingTop;
}
